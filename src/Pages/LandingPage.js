      ...
      <div className="flex flex-col w-full justify-center">
        ...
        <div className="flex-1 "  >
          <div className="lg:w-9/12 w-10/12 mx-auto py-16">
            <h2 className="text-3xl font-bold text-center "  data-aos="fade-down"
          data-aos-duration="2000">
              Let's <span className="text-indigo-600">create a resume</span> for
              your dream job
            </h2>
            <p className="my-5 text-center  lg:w-1/3  w-3/5 mx-auto text-gray-600"  data-aos="fade-down"
          data-aos-duration="2000">
          ...
          data-aos-duration="2000">
            ...
            <div className="lg:w-2/6 md:h-2/3  mx-auto mt-11"  data-aos="fade-down"
          data-aos-duration="2000">
              <img src={Hero} alt="" />
            </div>
          </div>
